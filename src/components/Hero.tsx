...
const Hero = () => {
  ...
  const [displayedName, setDisplayedName] = useState('');
  const [nameIndex, setNameIndex] = useState(0);
  const technologies = ['SQL', 'GA4', 'Power BI', 'Looker Studio', 'R', 'SEMrush'];
  const fullName = 'Nithin';
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Building Scalable <br />
              <span className="text-gradient">Marketing Insights</span>
              <br />
              with Modern{' '}
              <motion.span
                key={currentTech}
            ...
            <motion.p
              ...
              className="text-xl text-muted-foreground max-w-xl"
            >
              Marketing Analytics professional with 2+ years of consulting-based experience driving 
              engagement and qualified leads through data-driven insights.
            </motion.p>
          ...
          >
            ...
            >
              ...
              <img
                src={profileImage}
                alt="Nithin - Marketing Analytics"
                // className="relative rounded-full w-full max-w-lg  h-max mx-auto shadow-2xl border-4 border-champagne/30"
                className="relative rounded-full w-96 h-96 mx-auto shadow-2xl border-4 border-champagne/30 object-cover"
