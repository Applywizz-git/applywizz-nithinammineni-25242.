...
import { motion, useInView } from 'framer-motion';
import { useRef, useEffect, useState } from 'react';
import { BarChart, PieChart, Workflow, Target } from 'lucide-react';
...
const About = () => {
  const highlights = [
    { icon: BarChart, label: 'Analytics Tools', desc: 'GA4, SEMrush' },
    { icon: PieChart, label: 'Data Visualizations', desc: 'Power BI, Looker Studio' },
    { icon: Target, label: 'Digital Advertising', desc: 'Meta Ads, Google Ads' },
    { icon: Workflow, label: 'Analysis Workflows', desc: 'SQL, R, Advanced Excel' },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mx-auto space-y-8 mb-16">
          <motion.p
            ...
            data-aos="fade-up"
          >
            Marketing Analytics professional with 2+ years of consulting-based experience supporting market research, customer segmentation, and campaign performance analysis across global markets, currently pursuing a Master’s in Marketing Analytics at Illinois Institute of Technology.
          </motion.p>
          ...
          <motion.p
            ...
            data-aos-delay="100"
          >
            Proficient in SQL, Advanced Excel, GA4, Power BI, Looker Studio, R, and SEMrush to analyze traffic behavior, conversion trends, and funnel performance. Strong foundation in exploratory data analysis, forecasting-informed interpretation, dashboard reporting, and stakeholder insight communication.
          </motion.p>
        </div>
        ...
        >
          ...
          <Counter target={30} label="% Engagement Lift" />
        </motion.div>
