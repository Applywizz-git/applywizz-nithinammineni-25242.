...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, href: 'https://www.linkedin.com/in/nithin-ammineni/', label: 'LinkedIn' },
    { icon: Mail, href: 'mailto:nithinammineni01@gmail.com', label: 'Email' }
  ];
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          >
            <p className="text-sm text-platinum/60 flex items-center gap-2">
              © {currentYear} NITHIN. All rights reserved 
              <motion.span
                animate={{ 
                  scale: [1, 1.2, 1],
                }}
          ...
          >
            <p className="text-xs text-gradient font-heading tracking-wider">
              UNLOCKING HIDDEN MARKETING INSIGHTS
            </p>
          </motion.div>
        </div>
      </div>
