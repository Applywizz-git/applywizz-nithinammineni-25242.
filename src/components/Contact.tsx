...
const Contact = () => {
  ...
  const socialLinks = [
    // { icon: Github, label: 'GitHub', href: 'https://github.com', color: 'hover:text-[#333]' },
    { icon: Linkedin, label: 'LinkedIn', href: 'https://www.linkedin.com/in/nithin-ammineni/', color: 'hover:text-[#0077b5]' },
    { icon: Mail, label: 'Email', href: 'mailto:nithinammineni01@gmail.com', color: 'hover:text-accent' }
  ];
    ...
    <section id="contact" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-champagne to-sandstone mx-auto mb-6" />
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Have a project in mind or want to discuss marketing analytics opportunities? Let's connect!
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            <div className="glass-effect p-8 rounded-lg">
              ...
              <div className="space-y-4">
                <a 
                  href="mailto:nithinammineni01@gmail.com"
                  className="block text-center text-accent hover:text-champagne transition-colors"
                >
                  nithinammineni01@gmail.com
                </a>
                <a 
                  href="tel:+13123588269"
                  className="block text-center text-accent hover:text-champagne transition-colors"
                >
                  +1 (312) 358-8269
                </a>
