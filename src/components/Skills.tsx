...
const skillCategories = [
  {
    ...
    skills: ['SQL', 'R', 'Advanced Excel (Pivot Tables, Lookup Functions, Data Cleaning)', 'Exploratory Data Analysis', 'Statistical Analysis', 'Regression Analysis', 'Forecasting Methods']
  },
  {
    title: 'Data Visualization & BI Tools',
    skills: ['Power BI', 'Looker Studio', 'Dashboard Development', 'KPI Reporting', 'Data Visualization', 'Marketing Performance Dashboards']
  },
  {
    title: 'Marketing Analytics Tools',
    skills: ['GA4', 'SEMrush', 'Campaign Performance Analysis', 'Conversion Rate Analysis', 'Traffic Analysis', 'Funnel Analysis']
  },
  {
    title: 'Digital Advertising Analytics',
    skills: ['Google Ads Performance Analysis', 'Meta Ads Performance Analysis', 'Programmatic Analytics (DV360)', 'Campaign Attribution Analysis', 'Audience Segmentation Analysis']
  },
  {
    title: 'Market & Customer Insights Analytics',
    skills: ['Market Research Analysis', 'Competitive Analysis', 'Trend Analysis', 'Customer Segmentation', 'Consumer Behavior Analysis', 'Marketing Insight Generation']
  },
  {
    title: 'Experimentation & Optimization',
    skills: ['A/B Testing Support', 'Landing Page Performance Analysis', 'Email Campaign Performance Analysis', 'CTR/CPC/CPA Analysis']
  },
  {
    title: 'Data & Reporting Workflows',
    skills: ['Data Cleaning', 'Data Validation', 'Marketing KPI Tracking', 'Stakeholder Reporting', 'Cross-Functional Reporting', 'Data-Driven Decision Support']
  }
];

const topSkills = [
  { name: 'SQL', percentage: 95 },
  { name: 'Google Analytics 4', percentage: 92 },
  { name: 'Power BI', percentage: 90 },
  { name: 'Advanced Excel', percentage: 88 }
];
